...
<div class="addtripdetails">
    <div class="wanderlust-wrapper">
        <h1>Trip Details</h1>
        <form id="tripForm" onsubmit="return validateForm()"  method="POST" action="{{ route('admin.travellerdetails.update', $travellerdetails->id) }}"
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        pattern="[A-Za-z\s]+" title="Trip Name should not contain numbers" value="{{ $travellerdetails->tripname }}" required>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        min="0" step="0.01" value="{{ $travellerdetails->packagecost }}" required>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        pattern="[A-Za-z\s]+" title="Description should not contain numbers" required>{{ $travellerdetails->description }}</textarea>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        pattern="[A-Za-z\s]+" title="Hotel Name should not contain numbers" value="{{ $travellerdetails->hotelname }}" required>
                    ...
                    <td>
                        <div class="starlight-rating-system">
                            <input type="radio" id="5-stars" name="rating" value="5" required
                                   {{ $travellerdetails->rating == 5 ? 'checked' : '' }} />
                            <label for="5-stars" class="star">&#9733;</label>

                            <input type="radio" id="4-stars" name="rating" value="4"
                                   {{ $travellerdetails->rating == 4 ? 'checked' : '' }} />
                            <label for="4-stars" class="star">&#9733;</label>

                            <input type="radio" id="3-stars" name="rating" value="3"
                                   {{ $travellerdetails->rating == 3 ? 'checked' : '' }} />
                            <label for="3-stars" class="star">&#9733;</label>

                            <input type="radio" id="2-stars" name="rating" value="2"
                                   {{ $travellerdetails->rating == 2 ? 'checked' : '' }} />
                            <label for="2-stars" class="star">&#9733;</label>

                            <input type="radio" id="1-star" name="rating" value="1"
                                   {{ $travellerdetails->rating == 1 ? 'checked' : '' }} />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="visual-section"> <!-- renamed from image-section -->
                            <img class="scenic-view" src="{{ asset('storage/' . $travellerdetails->hotelimage) }}" alt="Pokhara Image"> <!-- renamed from image-section img -->
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="hotelLocation" name="hotellocation" placeholder="Enter hotel location" value="{{ $travellerdetails->hotellocation }}" required>
