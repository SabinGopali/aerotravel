        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    ...
                    <form
                            role="form"
                            action="{{ route('stripepayment.post') }}"
                            method="post"
                            ...
                            id="payment-form">
                            @csrf
                            <input class='form-control' name="passengerdetail_id" value="{{$schedule_flights_id}}" type='hidden'>
...
@if($p)
    <a href="{{ route('client.travellerboardingpass', ['id' => $p->id]) }}">
